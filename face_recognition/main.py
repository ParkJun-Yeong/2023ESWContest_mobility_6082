...
# junyeong_image = face_recognition.load_image_file("img/junyeong.jpg")
# junyeong_face_encoding = face_recognition.face_encodings(junyeong_image)[0]
#
...
while True:
    ...
    if process_this_frame:
        ...
        # small_frame = cv2.resize(frame, (0, 0), fx=0.25, fy=0.25) # this code crashes the system

        # Convert the image from BGR color (which OpenCV uses) to RGB color (which face_recognition uses)
        # rgb_small_frame = small_frame[:, :, ::-1]     # this code crashes the system
        rgb_frame = frame[:, :, ::-1]
